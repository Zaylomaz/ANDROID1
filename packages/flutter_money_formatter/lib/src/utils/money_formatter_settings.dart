...
///
/// This instance is used as a configurator for the [FlutterMoneyFormatter]
/// instance.
...
class MoneyFormatterSettings {
  ...
  /// The [symbol] that will be used on formatted output, default value
  /// is $ (Dollar Sign)
  String? symbol;

  /// The character that will be used as thousand separator on formatted
  /// output, default value is ',' (comma)
  String? thousandSeparator;

  /// The character that will be used as decimal separator on formatted
  /// output, default value is '.' (dot)
  String? decimalSeparator;

  /// The character that will be used as separator between the numbers
  /// and the symbol.
  String? symbolAndNumberSeparator;

  /// The fraction digits that will be used on formatted output, default
  /// value is 2.
  int? fractionDigits;
